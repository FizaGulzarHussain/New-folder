  ...
  return (
    <>
      ...
      <div className="  h-screen px-4 md:px-8">
        ...
        >
          <div className="hidden lg:block lg:w-1/2 bg-contain bg-[url('https://images.unsplash.com/photo-1627556704302-624286467c65?q=80&w=1374&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')]"></div>
          <div className="w-full p-8 lg:w-1/2">
            ...
            <div className="mt-4 flex items-center justify-between">
              ...
              <a href="/signup" className="text-xs text-white uppercas">
                or sign up
              </a>
              <span className="border-b w-1/5 md:w-1/4"></span>
            </div>
