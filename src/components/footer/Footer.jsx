...
const Footer = () => {
  ...
  return (
    <motion.footer
      className={`pt-10 text-white text-[16px] ${bg} `}
      initial="hidden"
      whileInView="visible"
      variants={fadeInUp}
    ...
    >
      <div className="max-w-screen-2xl mx-auto px-4 md:px-8">
            ...
            >
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-3 py-3 bg-white outline-none border focus:border-none shadow-sm rounded-lg"
                />
              </div>
              <button className="block w-auto py-3 px-6   text-center text-black bg-white hover:bg-opacity-75  rounded-lg shadow">
                Subscribe
              </button>
            </form>
          </div>
            ...
            <ul className="space-y-4 " key={idx}>
              ...
              {item.items.map((el, idx) => (
                <li key={idx}>
                  <a
                    href={el.href}
                    className="duration-150 tracking-[1px] hover:opacity-75"
                  >
                    {el.name}
                  </a>
                </li>
        ...
        <div className="mt-10 py-10 border-t items-center justify-between sm:flex tracking-[1px]">
          <p className="">© 2024 Scholar Finder. All rights reserved.</p>
          <div className="flex items-center gap-x-6  mt-6">
            <a href="#">
              <svg
                className="w-6 h-6 hover:opacity-70 duration-150"
                fill="none"
                viewBox="0 0 48 48"
              >
                <g clipPath="url(#a)">
